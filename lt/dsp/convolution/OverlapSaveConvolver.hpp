...
struct FloatSignal
{
    ...
    LT_NODISCARD auto begin() const -> float const* { return data_; }
    LT_NODISCARD auto cbegin() const -> float const* { return data_; }

    LT_NODISCARD auto end() -> float* { return begin() + size(); }
    LT_NODISCARD auto end() const -> float const* { return begin() + size(); }
    LT_NODISCARD auto cend() const -> float const* { return begin() + size(); }
    ...
    LT_NODISCARD auto data() const -> float const* { return data_; }
...
struct ComplexSignal
{
    ...
    LT_NODISCARD auto begin() const -> Complex<float> const* { return data_; }
    LT_NODISCARD auto cbegin() const -> Complex<float> const* { return data_; }

    LT_NODISCARD auto end() -> Complex<float>* { return begin() + size(); }
    LT_NODISCARD auto end() const -> Complex<float> const* { return begin() + size(); }
    LT_NODISCARD auto cend() const -> Complex<float> const* { return begin() + size(); }

    LT_NODISCARD auto size() -> size_t& { return size_; }
    LT_NODISCARD auto size() const -> std::size_t const& { return size_; }
    LT_NODISCARD auto data() -> Complex<float>* { return data_; }
    LT_NODISCARD auto data() const -> Complex<float> const* { return data_; }
