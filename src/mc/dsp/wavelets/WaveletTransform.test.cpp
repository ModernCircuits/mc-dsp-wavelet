...
SWT_ISWT_ROUNDTRIP("bior1.1")  // NOLINT
SWT_ISWT_ROUNDTRIP("bior1.3")  // NOLINT
SWT_ISWT_ROUNDTRIP("bior1.5")  // NOLINT
SWT_ISWT_ROUNDTRIP("bior2.2")  // NOLINT
SWT_ISWT_ROUNDTRIP("bior2.4")  // NOLINT
SWT_ISWT_ROUNDTRIP("bior2.6")  // NOLINT
SWT_ISWT_ROUNDTRIP("bior2.8")  // NOLINT
// SWT_ISWT_ROUNDTRIP("bior3.1") // NOLINT
SWT_ISWT_ROUNDTRIP("bior3.3")   // NOLINT
SWT_ISWT_ROUNDTRIP("bior3.5")   // NOLINT
SWT_ISWT_ROUNDTRIP("bior3.7")   // NOLINT
SWT_ISWT_ROUNDTRIP("bior3.9")   // NOLINT
SWT_ISWT_ROUNDTRIP("bior4.4")   // NOLINT
SWT_ISWT_ROUNDTRIP("bior5.5")   // NOLINT
SWT_ISWT_ROUNDTRIP("bior6.8")   // NOLINT
SWT_ISWT_ROUNDTRIP("rbior1.1")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior1.3")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior1.5")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior2.2")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior2.4")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior2.6")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior2.8")  // NOLINT
// SWT_ISWT_ROUNDTRIP("rbior3.1") // NOLINT
SWT_ISWT_ROUNDTRIP("rbior3.3")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior3.5")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior3.7")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior3.9")  // NOLINT
SWT_ISWT_ROUNDTRIP("rbior4.4")  // NOLINT
