...
template<typename T, typename U>
[[nodiscard]] constexpr auto cmp_equal(T t, U u) noexcept -> bool  // NOLINT(readability-identifier-naming)
{
...
template<typename T, typename U>
[[nodiscard]] constexpr auto cmp_not_equal(T t, U u) noexcept -> bool  // NOLINT(readability-identifier-naming)
{
    return !cmp_equal(t, u);
}

template<typename T, typename U>
[[nodiscard]] constexpr auto cmp_less(T t, U u) noexcept -> bool  // NOLINT(readability-identifier-naming)
{
    using cmp = detail::IntegerCompareImpl<T, U, std::is_signed<T>::value, std::is_signed<U>::value>;
    return cmp::less(t, u);
}
...
template<typename T, typename U>
[[nodiscard]] constexpr auto cmp_greater(T t, U u) noexcept -> bool  // NOLINT(readability-identifier-naming)
{
    return cmp_less(u, t);
}

template<typename T, typename U>
[[nodiscard]] constexpr auto cmp_less_equal(T t, U u) noexcept -> bool  // NOLINT(readability-identifier-naming)
{
    return !cmp_greater(t, u);
}

template<typename T, typename U>
[[nodiscard]] constexpr auto cmp_greater_equal(T t, U u) noexcept -> bool  // NOLINT(readability-identifier-naming)
{
    return !cmp_less(t, u);
}
}  // namespace mc
