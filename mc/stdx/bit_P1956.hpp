...
template<typename T>
[[nodiscard]] constexpr auto bit_width(T x) noexcept  // NOLINT(readability-identifier-naming)
...
template<typename T>
[[nodiscard]] constexpr auto bit_ceil(T x) noexcept  // NOLINT(readability-identifier-naming)
